...
#if defined(NDEBUG)
# error "Liskplayshare cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Liskplayshare Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("liskplayshare-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Liskplayshare: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Liskplayshare: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
