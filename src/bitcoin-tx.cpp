...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Liskplayshare Core liskplayshare-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  liskplayshare-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded liskplayshare transaction") + "\n" +
              "  liskplayshare-tx [options] -create [commands]   " + _("Create hex-encoded liskplayshare transaction") + "\n" +
              "\n";
